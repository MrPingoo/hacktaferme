 ...
 */
final class Version20180831225715 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE work CHANGE quantity quantity DOUBLE PRECISION DEFAULT NULL, CHANGE surface surface DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE work CHANGE quantity quantity DOUBLE PRECISION NOT NULL, CHANGE surface surface DOUBLE PRECISION NOT NULL');
    }
}
